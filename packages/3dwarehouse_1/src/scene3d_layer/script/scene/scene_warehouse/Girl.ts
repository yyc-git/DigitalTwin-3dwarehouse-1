...
import { getOctree, getScene, getState, setState } from "./WarehouseScene"
...
export let getResourceId = () => getName()

export let getResourcePath = (name) => `./${name}/girl/${getResourceId()}.fbx`

export let getIdleAnimationName = () => "idle"

export let getIdleAnimationResourceId = () => getIdleAnimationName()

export let getIdleAnimationResourcePath = (name) => `./${name}/girl/${getIdleAnimationResourceId()}.fbx`

export let getRunningAnimationName = () => "running"

export let getRunningAnimationResourceId = () => getRunningAnimationName()

export let getRunningAnimationResourcePath = (name) => `./${name}/girl/${getRunningAnimationResourceId()}.fbx`
